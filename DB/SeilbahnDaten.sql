...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 02. Jan 2025 um 22:20
...
(3, 9, 'Jochbahn (Brixen im Thale)', 'Jochbahn', 2015, '8-CLD/B', 'Brixen im Thale (AT)', 'Doppelmayr', 1100, 1674, 538, 2002, NULL, 6, 3000, NULL, 8, 'Oberflur', 1, 1, NULL, NULL),
...
(10, 10, 'Zinsbergbahn (Brixen im Thale)', 'Zinsbergbahn', 2019, '8/10-CGD', 'Brixen im Thale (AT)', 'Doppelmayr', 1280, 1667, 378, 1844, NULL, 6, 3434, 6, 8, 'Oberflur', 1, 1, NULL, 'Sessel-Gondelbahn Kombination:\r\n8 Pers. pro Sessellift\r\n10 Pers. pro Gondel'),
(11, 5, 'Würstlexpress (Brixen im Thale)', 'Würstlexpress', 1997, '1-SL', 'Brixen im Thale (AT)', 'Doppelmayr', 1268, 1292, 24, 180, NULL, 2, 800, NULL, 1, NULL, 0, 0, NULL, 'Dient nur als Zubringerlift, um von der Kälbersalvenbahn zur Zinsbergbahn zu gelangen'),
...
(14, 9, 'Eibergbahn (Scheffau)', 'Eibergbahn', 2024, '8-CLD', 'Scheffau (AT)', 'Doppelmayr', 1528, 1683, 155, 476, NULL, 5, 4570, 2, 8, 'Oberflur', 1, 1, NULL, 'beförderungsstärkste Sesselbahn der Welt\r\nTalstation in L-Form'),
